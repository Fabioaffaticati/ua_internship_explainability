...
def create_parser():
    ...
    parser.add_argument(
        ...
        dest="images_dir",
        type=str,
        help="Path to directory used to save the property maps generated.",
        default=os.getcwd(),
        )
	############################################################################
...
if __name__ == "__main__":
    ...
    if args.model_type == "padded":
        ...
        for batch in dataset:
            for mini in batch:
                i+=1
                with open(args.images_dir + 'im_' + str(i) + '.pkl','wb') as f:
                    pkl.dump(mini, f)
                names.append('im_'+str(i))
        #########################################
    ...
    try:
        ...
        data_source.data["im_name"] = names
